...
var shareicon = '';
var pic = '';
var systemtype = $api.getStorage('systemtype');
...
function dofavorite() {
    ...
    api.ajax({
        ...
        if (ret) {
            ...
            alert('收藏失败');
            console.log( JSON.stringify( err )+'收藏失败' );
        }
    });
}
                    ...
                    if (len.length > 0) {
                        ...
                        for (var i = 0; i < len.length; i++) {
                            ...
                            for (var q = 0; q < classdetail.length; q++) {
                                ...
                                if (classdetail[q].courses == undefined || classdetail[q].courses == ''|| classdetail[q].courses['id'] == undefined  ) {
                                    continue;
                                }
                        ...
                        if (curcourse.type ==1) {
                            ...
                            $api.attr($api.dom('#header .bgimg'), 'src', pic);
                            $("#audioplay").attr('src',coursevideourl);
                            //togglePlay();
                            $(".backimg").attr('src',pic);

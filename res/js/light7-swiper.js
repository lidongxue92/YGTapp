...
+function($){
    ...
    var PhotoBrowser = function (params) {
        ...
        var navbarTemplate = pb.params.navbarTemplate ||
                            '<header class="bar bar-nav" style="position:fixed;top:0">' +
                              '<a class="icon iconfont icon-shangyiye2 pull-left photo-browser-close-link' + (pb.params.type === 'popup' ?  " close-popup" : "") + '"></a>' +
        ...
        pb.open = function (index) {
            ...
            if (pb.params.type === 'popup') {
                ...
                pb.popup = $.popup('<div class="popup photo-browser-popup" style="background:#000;'+aac+'">' + htmlTemplate + '</div>');
